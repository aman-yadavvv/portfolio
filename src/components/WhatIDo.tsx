        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Provisioning scalable, secure AWS infrastructure using Terraform and Ansible.
                From VPCs to EC2, I build resilient environments.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              <h3>CI/CD & SEC</h3>
              <h4>Secure Delivery Pipelines</h4>
              <p>
                Building automated CI/CD pipelines with shift-left security.
                Integrating SonarQube, Trivy, and GitLeaks for secure deployments.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">GitLeaks</div>
